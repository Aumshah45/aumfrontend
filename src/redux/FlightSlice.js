...
export const fetchFlights = createAsyncThunk('flights/fetchFlights', async () => {
  const response = await axios.get(`${BASE_URL}/loadairlinesflight/{airline_code}`);  // Use actual airline_code parameter
...
export const deleteFlight = createAsyncThunk('flights/deleteFlight', async (flight_id) => {
    await axios.delete(`http://localhost:8084/admin/deleteFlight/${flight_id}`);
